...
class AdminCustomerController extends Controller
{
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'email' => 'required|email|unique:customers,email', // ✅ corrected table name
        ...
        try {
            // 1. Create the customer with a temporary password
            ...
            // 2. Set the password broker for customers
